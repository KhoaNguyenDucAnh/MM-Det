...
class TrainOption(BaseOption):
    def __init__(self):
        ...
        self.parser.add_argument(
            "--weight-decay", type=float, default=1e-6, help="weight decay"
        )
        ...
        self.parser.add_argument(
            "--save-epoch", type=int, default=5, help="interval for each saving"
        )
        self.parser.add_argument(
            "--display-step", type=int, default=50, help="display steps"
        )
        self.parser.add_argument("--log-step", type=int, default=100, help="log steps")
        self.parser.add_argument(
            "--val-step", type=int, default=1000, help="validation steps"
        )
        self.parser.add_argument(
            "--val-bound",
            type=float,
